...
AIRGLUE_SANDBOX_PROJECT_ID=# REPLACE ME
AIRGLUE_EXAMPLE_BUCKET_NAME=# REPLACE ME
AIRGLUE_COMPOSER_AIRFLOW_VERSION=1.10.14

ENVS := AIRGLUE_SANDBOX_PROJECT_ID=$(AIRGLUE_SANDBOX_PROJECT_ID) \
	AIRGLUE_COMPOSER_AIRFLOW_VERSION=$(AIRGLUE_COMPOSER_AIRFLOW_VERSION) \
	AIRGLUE_EXAMPLE_BUCKET_NAME=$(AIRGLUE_EXAMPLE_BUCKET_NAME)
